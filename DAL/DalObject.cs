...
namespace DalObject
{
    public class DalObject
    {
        ...
        public void AssignPackageSkimmer(int idp, int idq)//Assign a package to a skimmer
        {
            ...
            DataSource.ListPackage.RemoveAll(packag => packag.ID == idp);//Deleting the old skimmer object
            DataSource.ListPackage.Add(temp_p);//Deleting the new skimmer object includes the change
        }
